...
<head>
    ...
    <style>
        ...
        @media (prefers-reduced-motion: reduce) {
            .float-anim, .btn-primary { animation: none; transform: none; }
            .input-field, .login-card { transition: none; }
        }
    </style>
</head>
            ...
            <div class="w-full max-w-[440px]">
                ...
                <div class="text-center mb-10 float-anim">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-[0_4px_20px_rgba(45,125,210,0.12)] mb-5">
                        <svg class="w-8 h-8 text-primary-blue" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                ...
                <div class="login-card rounded-2xl p-8 sm:p-10">
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    autofocus
                                    required
                                    class="input-field w-full pl-10 pr-4 py-3 rounded-xl text-sm text-navy-text placeholder:text-slate-text/60 outline-none @error('username') border-danger-red @enderror"
                                >
                            </div>
                            @error('username')
                                <p class="mt-1.5 text-xs text-danger-red font-medium flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    required
                                    class="input-field w-full pl-10 pr-4 py-3 rounded-xl text-sm text-navy-text placeholder:text-slate-text/60 outline-none @error('password') border-danger-red @enderror"
                                >
                            </div>
                            @error('password')
                                <p class="mt-1.5 text-xs text-danger-red font-medium flex items-center gap-1">
                        ...
                        <!-- Submit -->
                        <button type="submit" class="btn-primary w-full py-3 rounded-xl text-sm font-semibold text-white tracking-wide cursor-pointer">
        ...
        <div class="hidden lg:flex w-[480px] bg-primary-blue relative overflow-hidden items-center justify-center p-12">
            ...
            <div class="relative text-center text-white space-y-6">
                <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-sm mb-4">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
                        <polyline points="3.27 6.96 12 12.01 20.73 6.96"/>
                        <line x1="12" y1="22.08" x2="12" y2="12"/>
                    </svg>
                ...
                <h2 class="text-2xl font-poppins font-semibold">Kelola Inventaris<br>dengan Mudah</h2>
                ...
                <div class="flex flex-wrap justify-center gap-3 pt-4">
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 text-[11px] font-medium text-white/80">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
                        Terstruktur
                    </span>
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 text-[11px] font-medium text-white/80">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                        Aman
                    </span>
                </div>
