...
<body class="h-full bg-slate-50 text-navy-text font-inter flex flex-col md:flex-row antialiased">
    ...
    <aside class="hidden md:flex flex-col w-[232px] bg-white border-r border-slate-100 fixed top-0 bottom-0 left-0 z-20">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1">
            ...
            <a href="/stok-movements" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->is('stok-movements*') ? 'bg-light-blue-bg text-primary-blue' : 'text-slate-text hover:bg-slate-50 hover:text-navy-text' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-slate-100 flex items-center justify-around px-4 z-30 shadow-lg">
        ...
        <a href="/stok-movements" class="flex flex-col items-center space-y-0.5 text-[10px] font-medium {{ request()->is('stok-movements*') ? 'text-primary-blue font-semibold' : 'text-slate-text' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
            </svg>
            <span>Stok</span>
